...
exports.setSecretToken = function(token, secret) {
    ...
    if(token && secret) {
        ...
        shared.oAuth1Table[token] = secret;
    }
};
...
exports.setup = function(connectURL, callbackURL, callback) {
    if(shared.Express) {
        ...
        shared.Express.get(connectURL, function(req, res){
            var client = shared.OAuthUtil.getClient(shared.oAuth1AccessURL, callbackURL);
        ...
        shared.Express.get(callbackPath, function(req, res){
            var client = shared.OAuthUtil.getClient(shared.oAuth1AccessURL);
