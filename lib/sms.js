/*
 * This file represents SMS API implementation of Creatary 
 */

var oauth = require('oauth');
var shared = require("./shared");
var sendURL = shared.apiURL + "/sms/send";
    ...
    shared.ServerUtil.listen(url, function(body) {
        ...
        if(typeof body === "object") {
            if (shared.oAuthv2) {
                ...
                shared.OAuth1.setSecretToken(body.access_token, body.token_secret);
            }
            callback(body);
        } else {
