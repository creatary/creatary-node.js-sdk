...
exports.init = function(consumerKey, consumerSecret, config) {
    ...
    if (shared.oAuth2) {
        shared.apiURL = shared.origin_api + '/2/';
    ...
    // Running in OAuth1 mode
        ...
        shared.apiURL = shared.origin_api + '/1/';
        ...
        exports.OAuth = {
        	setSecretToken: shared.OAuth1.setSecretToken
        }
    }
    ...
    var Location = require('./location').init();
    var Charging = require('./charging').init();
