...
exports.post = function(toToken, sendURL, body, callback) {
    if(!shared.oAuth2 && typeof shared.oAuth1Table[toToken] === "undefined") {
    ...
    if (shared.oAuth2) {
        ...
        client.post(sendURL, toToken, shared.oAuth1Table[toToken], JSON.stringify(body), "application/json", myCb);
    }
};
...
exports.get = function(toToken, sendURL, callback) {
    ...
    if (shared.oAuth2) {
        ...
        var client = shared.OAuth1.getClient(sendURL);
        client.get(sendURL, toToken, shared.oAuth1Table[toToken], myCb);
    }
};
